...
source "$SCRIPT_DIR/dav_common.sh" || { echo "Config failed"; return 1; }
...
# Ask for alias early
if gum confirm "Add shell alias for this project?"; then
...
if [ -f "$GLOBAL_ALIAS_FILE" ] && ! grep -q "alias createdp=" "$GLOBAL_ALIAS_FILE"; then
