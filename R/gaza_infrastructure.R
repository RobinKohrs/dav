# Gaza Infrastructure Damage Data Functions
# ==============================================================================
...
#'
#' @return A data frame containing the daily infrastructure damage data.
#'
#' @examples
...
#'
#' @export
gaza_infrastructure_damaged = function(minified = TRUE) {
    if (minified) {
        url = paste0(BASE_URL, "/v3/infrastructure-damaged.min.json")
    } else {
        url = paste0(BASE_URL, "/v3/infrastructure-damaged.json")
    }
    message(paste("Fetching infrastructure damage data from:", url))
    ...
    if (httr::status_code(response) == 200) {
        ...
        stop(paste(
            "Failed to fetch infrastructure damage data. Status code:",
